    ...
    <body>
        <header>
                    ...
                    <div class="nav-wrapper">
                        ...
                        <ul id="right-nav" class="right hide-on-med-and-down">
                            ...
                            <?php } if (isset($_SESSION['isAdmin'])) { ?>                                
                                <li><a href="views/AdminPage.php">Adrministration</a></li>
                            <?php } if (isset($_SESSION['userLog'])) { ?> 
            ...
            <ul id="slide-out" class="sidenav">          
                ...
                <?php } if (isset($_SESSION['isAdmin'])) { ?>   
                    <li><a href="views/AdminPage.php"><i class="material-icons">dashboard</i>Adrministration</a></li>
                <?php } ?> 
                <li><div class="divider"></div></li>
        ...
        <!--end carou-->
        <h3 class="center-align"><?= $addRDVSuccess ? 'Le rdv est enregistré' : '' ?></h3>        
        <?php if ($failaddrdv) { ?><h3 class="center-align error">Erreur. Rdv non validé</h3> <?php } ?>
        <!-- prestation-->         
