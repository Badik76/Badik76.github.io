...
<html lang="fr">
    ...
    <div class="container justify-align">
        <h2 class="center">Politique de confidentialité</h2>
...
Nous utilisons les renseignements ainsi collectés pour les finalités suivantes :<br />
        ...
        <h3>3. Droit d'opposition et de retrait</h3>
        <p>
            Nous nous engageons à vous offrir un droit d'opposition et de retrait quant à vos renseignements personnels.<br />
            Le droit d'opposition s'entend comme étant la possiblité offerte aux internautes de refuser que leurs renseignements personnels soient utilisées à certaines fins mentionnées lors de la collecte.<br />
        </p>
        <p>
        ...
        <p>
            ...
            Courriel : contact@wellnessreiki.com<br />		Section du site web : https://wellnessreiki.com/<br />	</p>
        <3>Droit d'accès</h3>
        <p>
            Nous nous engageons à reconnaître un droit d'accès et de rectification aux personnes concernées désireuses de consulter, modifier, voire radier les informations les concernant.<br />
        ...
        <ul>
            ...
            <li>GGestion des accès - personne autorisée</li>
