                ...
                <div class="card">
                    ...
                    <div class="card-content brdbot">
                        <p class="justify">L'énergie de Reiki peut être orientée efficacement vers n'importe qui et n'importe où dans le monde. 
                            ...
                            Le Reiki agit sur différents plans : Physique, Emotionnel et Spirituel.<br />
                            Par ce travail, il y a de grands allégements au niveau des douleurs physiques et des malaises psychiques mais il arrive, bien souvent, que l’état physique ne va s’améliorer que lorsque la personne aura libéré ses tristesses, ses peurs et ses souffrances anciennes. Il est, donc, important, d’accepter les transformations intérieures qui peuvent intervenir durant un traitement.</p></div>
                </div>
            </div>
        </div>
    </div>
