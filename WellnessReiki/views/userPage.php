    ...
    if (isset($_SESSION['userLog'])) {
        ...
        <div class="container center">          
            ...
            if ($userIsFind) {
                ...
                <?php }
                ?>
                <h3 class="center-align"><?= $upRDVSuccess ? 'Le rdv est modifié' : '' ?></h3>
                <ul class="collapsible">
                    <li class="active">
                        <div class="collapsible-header groundcolor"><h2><i class="material-icons">spa</i> Mes prochains RDV's <i class="material-icons">spa</i></h2></div>
                            ...
                            <div class="container row">                                                     
                                ...
                                if ($rdvFind) {
                                    if ($daterdv->users_id !== $users->users_id) {
                                        ...
                                        foreach ($rdvidUserList as $daterdv) {
                                            ?>
                                            ...
                                            <div class="col s6 m6 l4">
                                                <div class="card brdbot">
                                                    <div class="card-content">
                                                        <p><b><?= $daterdv->dateRDV_dateRDV ?></b></p> 
                                                        <p><?= $daterdv->timeRDV_timeRDV ?> </p>
                                                        <p><mark class="mark1"><b><?= $daterdv->prestations_name ?></b></mark></p>
                    ...
                    <li>
                        <div class="collapsible-header groundcolor"><h2><i class="material-icons">group</i>Mon Profil<i class="material-icons">group</i>
                            </h2></div>
                        <div class="collapsible-body">
                            <div class="container">
                    ...
                    <li>
                        <div class="collapsible-header groundcolor"><h2><i class="material-icons">spa</i> Mes anciens RDV's <i class="material-icons">spa</i></h2></div>
                        <div class="collapsible-body">
