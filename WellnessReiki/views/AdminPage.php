...
<html lang="fr">
    ...
    if (isset($_SESSION['isAdmin'])) {
        ...
        <div class="container center">
            ...
            <h3 class="center-align"><?= $superUserOK ? 'L\'utilisateur est un superUser' : '' ?></h3>
            <h3 class="center-align"><?= $superUserDEL ? 'L\'utilisateur n\'est plus superUser' : '' ?></h3>
            <h3 class="center-align"><?= $deleteOk ? 'L\'utilisateur a été supprimé' : '' ?></h3>
            <h3 class="center-align"><?= $productcategoryDEL ? 'La catégorie est supprimée ' : '' ?></h3>
            <h3 class="center-align"><?= $productDEL ? 'Le produit est supprimée ' : '' ?></h3>                                        
            <h3 class="center-align"><?= $addCatSuccess ? 'La catégorie est ajoutée ' : '' ?></h3>                
            <h3 class="center-align"><?= $upCatSuccess ? 'La catégorie est modifiée ' : '' ?></h3>
            <h3 class="center-align"><?= $deletecommentOk ? 'Le commentaire est effacé' : '' ?></h3>
            <h3 class="center-align"><?= $addProdSuccess ? 'Le produit est ajouté ' : '' ?></h3>
            <h3 class="center-align"><?= $upProdSuccess ? 'Le produit est modifié ' : '' ?></h3>
