...
<body>
    <header>
                ...
                <div class="nav-wrapper">
                    ...
                    <ul class="right hide-on-med-and-down">
                        ...
                        if (isset($_SESSION['isAdmin'])) {
                            ?>                                
                            <li class="<?= isset($adminPageTrue) ? $adminPageTrue : '' ?>"><a href="AdminPage.php">Adrministration</a></li>
                            <?php
                        }
        ...
        <ul id="mobile-demo" class="sidenav">          
            ...
            if (isset($_SESSION['isAdmin'])) {
                ?>   
                <li><a href="AdminPage.php"><i class="material-icons">dashboard</i>Adrministration</a></li>
                <?php
            }
            ?> 
            <li><div class="divider"></div></li>
